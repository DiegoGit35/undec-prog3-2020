...
//    }
    ...
    void test11addPiloto() throws ExceptionPiloto{
        ...
        Piloto p = new Piloto("30-64140555-4", 1234321, "estrada", "Diego", f1);
        Piloto p2 = new Piloto("30-64140341-2", 1234312, "perez", "jose", f2);
        Piloto p3 = new Piloto("30-64149492-3", 1234353, "jimenez", "pedro", f3);
        al.addPiloto(p);
        al.addPiloto(p2);
        al.addPiloto(p3);
    ...
    void test14buscarPilotoxApellido() throws ExceptionPiloto {
        ...
        Piloto p = new Piloto("30-64140555-4", 1234321, "estrada", "Diego", f1);
        Piloto p2 = new Piloto("30-64140341-2", 1234312, "perez", "jose", f2);
        Piloto p3 = new Piloto("30-64149492-3", 1234353, "perez", "pedro", f3);
        al.addPiloto(p);
        al.addPiloto(p2);
        al.addPiloto(p3);
        lp.add(p2);
